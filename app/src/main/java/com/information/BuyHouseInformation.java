 ...
 */
public class BuyHouseInformation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("House Information");
    ...
    public void Book(View v)
    {
        ...
        Intent i = new Intent(BuyHouseInformation.this, ReserveProperty.class);
