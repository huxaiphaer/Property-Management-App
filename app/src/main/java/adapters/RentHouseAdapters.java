 ...
 */
public class RentHouseAdapters extends ArrayAdapter<ModelClass> {
    private Context context;
    private List<ModelClass> modelClassList =null;
    private ArrayList<ModelClass> arraylist;

    public RentHouseAdapters(Context context, int resource, List<ModelClass> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        acres.setText(modelClass.getRooms());
